...
//--------------------------------------------------------
  ...
  $scope.conge={type:$scope.types[0].value};
    ...
    //vérif à faire si meme jour alors matin pour le premier et aprem pour l'autre
    if(($scope.date_start.date!="" ||$scope.date_end.date!="") && $scope.date_start.date!=$scope.date_end.date){
      $scope.lolilol={"fuck":0,"name":'Congé1'}
      $scope.date_start.half=$scope.types[0].value;
    }
